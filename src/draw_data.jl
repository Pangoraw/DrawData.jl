...
# ╔═╡ fd21bfac-3ecd-42f6-b131-7b7056e3ccf8
md"""
# DrawData.jl
...
# ╔═╡ c3d32b8a-ede7-46ce-9fc3-b7af1c0be507
js_code = """
...
# ╔═╡ 9b52f300-8fb0-4261-9f85-3ebbe38338b6
css_code = """
.draw_data {
	display: flex;
}
...
# ╔═╡ 636c7732-a6d0-4f1d-9e7c-488008a8c747
...
# ╔═╡ cae664a0-e429-4c57-9c59-3e04907bc32d
"<p>Color map → " * (map(get_color.(1:9)) do color
	"""<span style="display: inline-block; height: 10px; width: 10px; background-color: $color"></span>"""
end |> join) |> HTML
...
# ╔═╡ e696bb2a-9000-48fe-897c-8013d36e8232
...
# ╔═╡ 7449975e-03d2-4ba8-b159-fcb98465d3fe
@only_in_pluto begin
...
# ╔═╡ b04ebfc8-a13d-439d-9366-ce056d573a0d
@only_in_pluto begin
	scatter(X1, Y1)
	scatter!(X2, Y2)
	scatter!(X3, Y3)
...
# ╔═╡ ed86d21a-336b-4c64-81ba-82ae1a377be8
...
function show_pretty_source(code, language)
	...
	HTML("""
		<details>
		<summary>$capital_language source code</summary>
		$pretty_code
		</details>
	""")
end;
